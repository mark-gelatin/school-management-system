                ...
                <div class="form-step" id="step2Form" style="display:none;">
                    <div class="form-step-header">
                        ...
                        <div class="step2-header-right">
                            ...
                            <span class="form-footer small">Already have an Account? <a href="staff-login.html">Login here</a></span>
                    ...
                    <div class="form-field-row">
                        <div class="form-field full">
                            ...
                            <input type="text" id="motherName" name="motherName" autocomplete="off" required value="<?= htmlspecialchars($_POST['motherName'] ?? '') ?>">
                        </div>
                    </div>
                    <div class="form-field-row">
                        <div class="form-field full">
                    ...
                    <div class="form-field-row">
                        <div class="form-field full">
                            ...
                            <input type="text" id="fatherName" name="fatherName" autocomplete="off" required value="<?= htmlspecialchars($_POST['fatherName'] ?? '') ?>">
                        </div>
                    </div>
                    <div class="form-field-row">
                        <div class="form-field full">
