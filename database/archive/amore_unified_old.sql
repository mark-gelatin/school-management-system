-- Unified Colegio de Amore Database
-- Consolidates admission portal, student management, admin panel,
-- course/section, requirement tracking, and legacy login data into one schema.
-- Import this single file into MySQL/MariaDB to provision the system.
